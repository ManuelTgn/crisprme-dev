...
__device__ const Cigarx<u64>::Inner CIGARX_ENCODE_64[8] = {
    Cigarx<u64>::Inner::X, // 0b000 invalid!
    Cigarx<u64>::Inner::D, // 0b001 OK
    Cigarx<u64>::Inner::I, // 0b010 OK
    Cigarx<u64>::Inner::M, // 0b011 OK
    Cigarx<u64>::Inner::X, // 0b100 invalid!
    Cigarx<u64>::Inner::D, // 0b101 OK
    Cigarx<u64>::Inner::I, // 0b110 OK
    Cigarx<u64>::Inner::X, // 0b111 OK
};
