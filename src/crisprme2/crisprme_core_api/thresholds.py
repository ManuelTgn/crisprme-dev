...
class Thresholds:
    ...
    def __init__(self, max_mm: int, max_bdna: int, max_brna: int, loggers: CrisprmeLoggers) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self._max_mm == other._max_mm and self._max_bdna == other._max_bdna and self._max_brna == other._max_brna
