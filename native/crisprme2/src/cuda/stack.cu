...
//__device__ const char *STEP_CIGARX = "EDIMEDI=";
__device__ const Cigarx<u64>::Inner CIGARX_ENCODE_64[8] = {
	Cigarx<u64>::Inner::X, // 0b0'00 invalid!
	Cigarx<u64>::Inner::D, // 0b0'01 OK
	Cigarx<u64>::Inner::I, // 0b0'10 OK
	Cigarx<u64>::Inner::M, // 0b0'11 OK
	Cigarx<u64>::Inner::X, // 0b1'00 invalid!
	Cigarx<u64>::Inner::D, // 0b1'01 OK
	Cigarx<u64>::Inner::I, // 0b1'10 OK
	Cigarx<u64>::Inner::X, // 0b1'11 OK
};
...
struct Step
{
	...
	__device__ __forceinline__ Cigarx<u64>::Inner to_cigarx_op_u64(bool mismatch)
	{
